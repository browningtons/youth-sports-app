...
export const INITIAL_SCHEDULE = [
  ...
  { id: 7, date: 'Sat, Feb 28', time: '1:00 PM', opponent: 'Team Pearce', location: 'Mount Ogden Junior High', isHome: false, result: 'W', teamScore: 44, oppScore: 25 },
...
export const STANDINGS_DATA = [
  ...
  { rank: 5, name: 'Team Brown', w: 3, l: 4, pct: '.429' },
  { rank: 6, name: 'Team Wood', w: 2, l: 5, pct: '.286' },
  { rank: 7, name: 'Team Smergut', w: 1, l: 6, pct: '.143' },
  { rank: 8, name: 'Team Pearce', w: 0, l: 7, pct: '.000' },
];
...
export const LEAGUE_RESULTS_WEEKS_1_TO_7 = [
  ...
  { week: 7, homeTeam: 'Team Pearce', awayTeam: 'Team Brown', homeScore: 25, awayScore: 44 },
];
